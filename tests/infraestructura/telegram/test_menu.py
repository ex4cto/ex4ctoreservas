...
class TestCatalogo:
    ...
    def test_catalogo_tiene_24_comandos(self) -> None:
        assert len(CATALOGO_COMANDOS) == 24
...
class TestComandosParaTier:
    ...
    def test_propietario_ve_todos_24(self) -> None:
...
class TestComandosBot:
    ...
    def test_propietario_retorna_24_botcommands(self) -> None:
