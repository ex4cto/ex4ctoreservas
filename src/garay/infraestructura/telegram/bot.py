...
from garay.infraestructura.telegram.handlers_tours import (
    ...
    handle_edh_lista,
    handle_edh_neto_hor_ingresar,
    handle_edh_neto_hor_seleccionar,
    handle_edt_confirma,
    handle_edt_familia,
    handle_edt_ficha,
...
def crear_aplicacion(token: str) -> Application:  # type: ignore[type-arg]
    ...
    gestionar_ventas_conv_handler = ConversationHandler(
        ...
        states={
            ...
            GV_EDIT_FAMILIA: [
                _CB(handle_gv_edit_familia, pattern=r"^gv_familia_.+$"),
                _CB(handle_gv_edit_familia, pattern=r"^gv_volver_detalle$"),
            ],
            GV_EDIT_SERVICIO: [
                _CB(handle_gv_edit_servicio, pattern=r"^gv_tour_.+$"),
                _CB(handle_gv_edit_servicio, pattern=r"^gv_volver_familias$"),
            ],
            GV_EDIT_TOUR_VALOR: [
    ...
    editar_tour_conv_handler = ConversationHandler(
        ...
        states={
            ...
            EDH_NETO_HOR_SELECCIONAR: [
                _CB(handle_edh_neto_hor_seleccionar, pattern="^edh_neto_hor:"),
                _CB(handle_edh_neto_hor_seleccionar, pattern="^edh_neto_hor_listo$"),
            ],
            EDH_NETO_HOR_INGRESAR: [
                MessageHandler(_TEXT, handle_edh_neto_hor_ingresar),
            ],
        },
        fallbacks=[
            CommandHandler("cancelar", cmd_cancelar),
